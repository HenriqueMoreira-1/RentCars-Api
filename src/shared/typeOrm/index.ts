...
export const dataSource = new DataSource({
  ...
  migrations: [CreateRolesTable1673793794633, CreateCategory1674672942997, CreateSpecification1674673739060, CreateUsers1674811301688, AlterUserAddAvatar1675113522881],
  synchronize: true,
})
